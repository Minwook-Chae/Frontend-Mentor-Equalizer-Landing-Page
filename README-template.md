...
I learned more about z-index and the stacking context.
...
Concerning line-height, at one point, I used something like 4.8rem to achieve a line height of 48px, but would it be better to use unitless units instead so a line-height of 1.2 on a 40px font-size?
